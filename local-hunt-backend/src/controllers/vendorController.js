...
exports.getAllVendors = async (req, res, next) => {
  try {
    const { category, search, colony, isOpen, sortBy, sortOrder } = req.query;
    const isOpenBool = isOpen !== undefined ? (isOpen === 'true') : undefined;
    const params = { category, search, colony, isOpen: isOpenBool, sortBy, sortOrder };
    const vendors = await VendorModel.queryVendors(params);
