...
exports.updateReviewStatus = async (req, res, next) => {
  try {
    ...
    // If review status changes, re-calculate vendor's average rating
    await VendorModel.updateVendorRating(updatedReview.vendorId);
...
exports.deleteReview = async (req, res, next) => {
  try {
    ...
    // After deleting, re-calculate vendor's average rating
    await VendorModel.updateVendorRating(reviewToDelete.vendorId);
